...
def test_apple_send_communication_routes_to_mail_with_default_account(monkeypatch, tmp_path) -> None:
    monkeypatch.setenv("APPLE_AGENT_MCP_STATE_FILE", str(tmp_path / "prefs.json"))
    load_settings.cache_clear()
    tools.apple_update_preferences(default_mail_account="Contact@JonathanRReed.com", preferred_communication_channel="mail")
    ...
    assert captured["from_account"] == "Contact@JonathanRReed.com"

...
on run argv
    ...
    tell application "Mail"
        set newMessage to make new outgoing message with properties {visible:false, subject:subjectText, content:bodyText}
        tell newMessage
        ...
        return "true" & fieldSeparator & my sanitizeText(subjectText) & recordSeparator
    end tell
end run

...
This server gives an AI agent one entrypoint for Apple Mail, Calendar, Reminders, Messages, Notes, and Shortcuts. It reuses the standalone servers in this repo and exposes one unified MCP surface on top of them.
...
- one install target instead of six separate agent configs
...
- cross-app prompts
- the delegated Mail, Calendar, Reminders, Messages, Notes, and Shortcuts tools
...
- [Apple Calendar MCP](../ICal-MCP/README.md)
